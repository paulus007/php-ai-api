...
class TemplatePartController extends AbstractController
{
    ...
    {
        return new JsonResponse([
            $this->templatePartService->putTemplatePart($request->toArray(), $id)
        ]);
    }
    ...
    {
        return new JsonResponse([
            $this->templatePartService->patchTemplatePart($request->toArray(), $id)
        ]);
    }
    ...
    {
        return new JsonResponse([
            $this->templatePartService->deleteTemplatePart($id)
        ]);
    }
